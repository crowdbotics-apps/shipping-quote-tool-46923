"""
Django settings for shipping_quote_tool_46923 project.
...
ROOT_URLCONF = 'shipping_quote_tool_46923.urls'
...
WSGI_APPLICATION = 'shipping_quote_tool_46923.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shipping_quote_tool_46923 API",
    "DESCRIPTION": "API documentation for shipping_quote_tool_46923 App",
    "VERSION": "v1",
}
